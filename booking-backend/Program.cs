...
using booking_backend.Middleware;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new()
    {
        ...
        Version = "v1",
        Description = "API for managing business bookings, services, and customers"
    });
});
...
// Register hosted service for periodic booking reminders

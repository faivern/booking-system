...
using booking_backend.DTOs.Common;
using booking_backend.Exceptions;

namespace booking_backend.Middleware;
...
public class ExceptionHandlingMiddleware
{
    ...
    private static Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        switch (exception)
        {
            ...
            default:
                // For unhandled exceptions, only expose generic message in production

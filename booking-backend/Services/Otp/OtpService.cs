...
public class OtpService : IOtpService
{
    ...
    {
        // Use RandomNumberGenerator static methods (RNGCryptoServiceProvider is obsolete)
        int randomNumber = System.Security.Cryptography.RandomNumberGenerator.GetInt32(0, 1000000);
